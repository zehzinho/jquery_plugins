(function($) {
  $.fn.autocompletecombo = function (settings) {
    var i18nDatabase = {
      pt: {
    ...
    var lang = i18nDatabase[options.lang];
    ...
    if ($(containerSelector).length == 0) {
       ...
       if (options.toLoad != null && options.toLoad.length == 0) {
        containerDefinition  += '<tr><td colspan="' + numOfColumns + '" class="jquery-autocompletecombo-container-no-items-selected-msg">' + lang.noItemsSelectedMsg + '</td></tr>';
       }
    ...
    this.autocomplete({
     minLength: 3,
     change: function() {searchField.val('');},
     source:
       function(req, add){
